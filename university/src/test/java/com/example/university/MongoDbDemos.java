...
//
//	    Department d = departmentRepository.findAll().doOnEach(departmentSignal -> {
//	        System.out.println(departmentSignal.get());
//        });
//        //***************Staff query methods***************
...
//        Flux<Staff> flux = staffRepository.findAll(sortByLastName)
//                .doFinally(System.out::println(s));
//
